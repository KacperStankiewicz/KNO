# Example source on https://www.machinelearningplus.com/deep-learning/linear-regression-tensorflow/
...
y_train = x_train ** 2 + x_train * np.random.normal(0, 1, 100) + np.random.normal(0, 1, 100)
